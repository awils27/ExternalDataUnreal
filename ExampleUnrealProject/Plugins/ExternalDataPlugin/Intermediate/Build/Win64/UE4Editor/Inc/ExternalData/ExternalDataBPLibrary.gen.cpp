...
// End Cross Module References
	...
	DEFINE_FUNCTION(UExternalDataBPLibrary::execLoadFloatData)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<float>*)Z_Param__Result=UExternalDataBPLibrary::LoadFloatData(Z_Param_FileName);
		P_NATIVE_END;
	}
